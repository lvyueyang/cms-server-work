...
export const getListApi = (body: TrackMetaEventQueryListDto) => {
	return request.post<TrackMetaEventListResponseDto>(
		`${AIP_FIX}/track_meta_event/list`,
		body,
	);
};
...
export const getDetailApi = (id: number) => {
	return request.post<TrackMetaEventDetailResponseDto>(
		`${AIP_FIX}/track_meta_event/info`,
		{ id },
	);
};
...
export const createApi = (body: TrackMetaEventCreateDto) => {
	return request.post<Result<string>>(
		`${AIP_FIX}/track_meta_event/create`,
		body,
	);
};
...
export const updateApi = (body: TrackMetaEventUpdateDto) => {
	return request.post<Result<string>>(
		`${AIP_FIX}/track_meta_event/update`,
		body,
	);
};
...
export const removeApi = (id: number) => {
	return request.post<Result<number>>(`${AIP_FIX}/track_meta_event/delete`, {
		id,
	});
};
