...
import { DictSelect } from '@/routes/_main/dict/module/Select';
import { DictPreview } from '@/routes/_main/dict/module/Preview';
...
export const Route = createFileRoute('/_main/banner/list')({
