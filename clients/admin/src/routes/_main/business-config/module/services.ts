...
export const getListApi = (body: BusinessConfigQueryListDto) => {
	return request.post<BusinessConfigListResponseDto>(
		`${AIP_FIX}/business_config/list`,
		body,
	);
};
...
export const getDetailApi = (id: number) => {
	return request.post<BusinessConfigDetailResponseDto>(
		`${AIP_FIX}/business_config/info`,
		{ id },
	);
};
...
export const createApi = (body: BusinessConfigCreateDto) => {
	return request.post<Result<string>>(
		`${AIP_FIX}/business_config/create`,
		body,
	);
};
...
export const updateApi = (body: BusinessConfigUpdateDto) => {
	return request.post<Result<string>>(
		`${AIP_FIX}/business_config/update`,
		body,
	);
};
...
export const removeApi = (id: number) => {
	return request.post<Result<number>>(`${AIP_FIX}/business_config/delete`, {
		id,
	});
};
