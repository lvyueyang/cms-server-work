...
import { createApi, createMultiApi, getListApi, removeApi, updateApi } from './module';
    ...
    "value": "news"
      ...
      >
        ...
        <Form
          form={formModal.form}
          labelCol={{ span: 4 }}
          initialValues={{ lang: ContentLang.EN_US }}
        >
          ...
          <Form.Item label="翻译值" name="value" rules={[{ required: true }]}>
            <Input.TextArea />
          </Form.Item>
