...
/** 新增 */
export class TrackMetaEventCreateDto extends PickType(TrackMetaEvent, [
	"name",
	"cname",
	"desc",
]) {
...
/** 查询列表 */
export class TrackMetaEventQueryListDto extends PaginationAndOrder<
	keyof TrackMetaEvent
> {
