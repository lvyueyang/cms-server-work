...
/** 新增 */
export class UserAdminCreateDto extends PickType(UserAdmin, [
	"username",
	"password",
	"cname",
	"email",
...
/** 更新 */
export class UserAdminUpdateDto extends PickType(UserAdminInfo, [
	"cname",
	"id",
	"avatar",
]) {}
...
/** 更新用户密码 */
export class UserAdminUpdatePasswordDto extends PickType(UserAdmin, [
	"password",
	"id",
]) {}
...
export class UserAdminCreateRootDto extends PickType(UserAdmin, [
	"email",
	"cname",
	"password",
	"username",
...
export class UserAdminForgetPasswordDto extends PickType(UserAdmin, [
	"email",
	"password",
]) {
	@ApiProperty({
...
export class UserAdminHasRootUserResponseDto extends ResponseResult {
	@ApiProperty({
		description: "是否已存在超级管理员账号",
	})
