...
export class TrackMetaEventController {
	...
	@AdminRoleGuard(
		createPerm("admin:track_meta_event:list", `获取${MODULE_NAME}列表`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:track_meta_event:info", `获取${MODULE_NAME}详情`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:track_meta_event:create", `创建${MODULE_NAME}`),
	)
	async apiCreate(
		@Body() data: TrackMetaEventCreateDto,
	...
	@AdminRoleGuard(
		createPerm("admin:track_meta_event:update", `更新${MODULE_NAME}`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:track_meta_event:delete", `删除${MODULE_NAME}`),
	)
