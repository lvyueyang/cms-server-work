...
import { BusinessConfigCreateDto, BusinessConfigInfo, BusinessConfigUpdateDto } from '@cms/api-interface';
import {
  contentType2Label,
  createI18nColumn,
  enumMapToOptions,
      ...
      >
        ...
        <Form form={formModal.form} labelCol={{ span: 4 }} initialValues={{ redundancy_count: 1 }}>
          ...
          <Form.Item label="编码" name="code" rules={[{ required: true }]}>
            <Input style={{ width: 200 }} disabled={formModal.formModal.type !== ModalType.CREATE} />
          </Form.Item>
