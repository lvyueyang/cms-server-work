...
import {
	...
	removeApi,
	updateApi,
} from "./system-translation-module";
  ...
  },
  {
    ...
    "value": "news"
										...
										<ul>
											...
											<li>
												<code>lang</code>：语言代码，例如 <code>en-US</code>{" "}
												表示英文。
											</li>
											<li>
...
export const Route = createFileRoute("/_main/i18n/system-translation")({
	component: SystemTranslationPage,
});
