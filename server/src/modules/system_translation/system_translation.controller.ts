...
export class SystemTranslationController {
	...
	@AdminRoleGuard(
		createPerm("admin:system_translation:list", `获取${MODULE_NAME}列表`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:system_translation:info", `获取${MODULE_NAME}详情`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:system_translation:create", `新增${MODULE_NAME}`),
	)
	...
	@AdminRoleGuard(
		createPerm(
			"admin:system_translation:multi_create",
			`批量创建${MODULE_NAME}`,
		),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:system_translation:update", `修改${MODULE_NAME}`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:content_translation:export", `导出${MODULE_NAME}`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:system_translation:delete", `删除${MODULE_NAME}`),
	)
