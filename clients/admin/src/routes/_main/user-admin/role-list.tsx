...
import type { AdminRoleCreateDto, AdminRoleInfo } from "@cms/api-interface";
	...
	return (
		<>
			<PageTable<TableItem>
				...
				search={false}
				request={(params) => {
					return getListApi({ ...transformPagination(params) }).then(
						({ data }) => {
...
export const Route = createFileRoute("/_main/user-admin/role-list")({
