...
export const getListApi = (body: SystemTranslationQueryListDto) => {
	return request.post<SystemTranslationListResponseDto>(
		`${AIP_FIX}/system_translation/list`,
		body,
	);
};
...
export const getDetailApi = (id: number) => {
	return request.post<SystemTranslationDetailResponseDto>(
		`${AIP_FIX}/system_translation/info`,
		{
			id,
		},
	);
...
export const createApi = (body: SystemTranslationCreateDto) => {
	return request.post<Result<string>>(
		`${AIP_FIX}/system_translation/create`,
		body,
	);
};
/** 批量创建 */
export const createMultiApi = (body: SystemTranslationMultiCreateDto) => {
	return request.post<Result<string>>(
		`${AIP_FIX}/system_translation/create/multi`,
		body,
	);
};
...
export const updateApi = (body: SystemTranslationUpdateDto) => {
	return request.post<Result<string>>(
		`${AIP_FIX}/system_translation/update`,
		body,
	);
};
...
export const removeApi = (id: number) => {
	return request.post<Result<number>>(`${AIP_FIX}/system_translation/delete`, {
		id,
	});
};
...
export const exportApi = (export_type?: ExportFileType) => {
	return request
		.post<Result<null>>(
			`${AIP_FIX}/system_translation/export`,
			{ export_type },
			{ responseType: "blob" },
		)
