...
/** 新增 */
export class TrackMetaPropertiesCreateDto extends PickType(
	TrackMetaProperties,
	["name", "cname", "desc", "type"],
) {}

/** 修改 */
export class TrackMetaPropertiesUpdateDto extends PickType(
	TrackMetaProperties,
	["id", "cname", "desc"],
) {}
...
/** 查询列表 */
export class TrackMetaPropertiesQueryListDto extends PaginationAndOrder<
	keyof TrackMetaProperties
> {
