...
/** 查询翻译列表 */
export const getTranslationListApi = (
	params: ContentTranslationQueryListDto,
) => {
	return request.post<Result<ContentTranslationListResponse>>(
		`${AIP_FIX}/i18n/list`,
		params,
	);
};
...
/** 批量创建或更新翻译 */
export const batchUpsertTranslationsApi = (
	body: ContentTranslationBatchBody,
) => {
