...
/** 修改 */
export class SystemTranslationUpdateDto extends PartialType(
...
/** 查询列表 */
export class SystemTranslationQueryListDto extends PaginationAndOrder<
	keyof SystemTranslation
> {
