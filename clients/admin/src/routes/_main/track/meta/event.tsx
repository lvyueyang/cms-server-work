...
import { createApi, getListApi, removeApi, updateApi } from './event-module';
import { PropertiesSelect } from '@/routes/_main/track/meta/properties-module/Select';
...
export const Route = createFileRoute('/_main/track/meta/event')({
  component: TrackMetaEventListPage,
});
