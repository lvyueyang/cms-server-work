...
export class PublicArticleController {
	...
	@AdminRoleGuard(
		createPerm("admin:public_article:list", `获取${MODULE_NAME}列表`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:public_article:info", `获取${MODULE_NAME}详情`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:public_article:create", `新增${MODULE_NAME}`),
	)
	async apiCreate(
		@Body() data: PublicArticleCreateDto,
	...
	@AdminRoleGuard(
		createPerm("admin:public_article:update", `修改${MODULE_NAME}`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:public_article:delete", `删除${MODULE_NAME}`),
	)
