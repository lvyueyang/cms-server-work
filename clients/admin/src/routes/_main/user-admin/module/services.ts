...
export const getUserList = (pagination: Pagination) => {
	return request.post<UserAdminListResponseDto>(
		`${AIP_FIX}/admin-user/list`,
		pagination,
	);
};
...
export const getUserDetail = (id: number) => {
	return request.post<UserAdminInfoResponseDto>(`${AIP_FIX}/admin-user/info`, {
		id,
	});
};
...
export const createUser = (body: UserAdminCreateDto) => {
	return request.post<UserAdminIdResponseDto>(
		`${AIP_FIX}/admin-user/create`,
		body,
	);
};
...
export const resetpasswordUser = (body: UserAdminUpdatePasswordDto) => {
	return request.post<UserAdminIdResponseDto>(
		`${AIP_FIX}/admin-user/reset-password`,
		body,
	);
};
