...
export class SystemConfigController {
	constructor(
		private services: SystemConfigService,
	...
	@AdminRoleGuard(
		createPerm("admin:system_config:list", `获取${MODULE_NAME}列表`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:system_config:info", `获取${MODULE_NAME}详情`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:system_config:create", `新增${MODULE_NAME}`),
	)
	async apiCreate(
		@Body() data: SystemConfigCreateDto,
	...
	@AdminRoleGuard(
		createPerm("admin:system_config:update", `修改${MODULE_NAME}`),
	)
	...
	@AdminRoleGuard(
		createPerm("admin:system_config:delete", `删除${MODULE_NAME}`),
	)
